    ...
    <>
      <div className="flex-1 space-y-6 p-8 pt-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Customer Complain</h2>
              ...
              >
                ...
                <div className="p-4 space-y-3 border-b border-slate-200 dark:border-slate-700">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className={`text-xs font-semibold flex items-center gap-1 ${getPriorityColor(complain.priority)}`}
                    >
                ...
                <div className="p-4 space-y-3 flex-1">
                  <div className="space-y-3">
                    ...
                    <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950 dark:to-orange-950 rounded-lg border-2 border-red-200 dark:border-red-800 p-3 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  {complain.penyelesaian && (
                    <div className="space-y-3">
                      ...
                      <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 rounded-lg border-2 border-green-200 dark:border-green-800 p-3 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Perusahaan</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Divisi</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Komplain</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Priority</th>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Tanggal</th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Aksi</th>
                  </tr>
                </thead>
