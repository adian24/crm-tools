        ...
        <div className="bg-white/95 backdrop-blur-sm border border-slate-200 rounded-xl px-4 py-3 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <div className="flex-shrink-0">
              <h2 className="text-xl font-bold text-slate-900">Pencapaian PRM & Referral</h2>
              <p className="text-xs text-muted-foreground mt-0.5">Kelola data pencapaian PRM dan Referral per bulan</p>
            </div>
